...
export const L = {
  ...
  "nav.kompass": { lv: "Kompass", en: "Compass" },
  "kompass.heading": { lv: "Vēlēšanu kompass", en: "Election compass" },
  "kompass.intro": {
    lv: "Atbildi uz apgalvojumiem un salīdzini savas atbildes ar 14 sarakstu CVK programmās rakstīto. Katru saraksta pozīciju pamato citāts no programmas.",
    en: "Answer the statements and compare your views with what the 14 lists wrote in their CVK programmes. Every list position is backed by a programme quote.",
  },
  "kompass.disclaimer": {
    lv: "Šis nav balsošanas ieteikums. Salīdzinājums balstās tikai publicētajās CVK programmās: ja programma par kādu jautājumu klusē, tas nenozīmē, ka saraksts ir pret - tāpēc klusēšana samazina salīdzināmību, nevis sakritību. Rezultāts neņem vērā kandidātu pieredzi, darbus vai uzticamību.",
    en: "This is not a voting recommendation. The comparison rests only on the published CVK programmes: silence on a topic does not mean a list is against it, so silence lowers comparability rather than the match. The result ignores candidates' record, deeds and credibility.",
  },
  "kompass.start": { lv: "Sākt", en: "Start" },
  "kompass.restart": { lv: "Sākt no jauna", en: "Start over" },
  "kompass.progress": { lv: "no", en: "of" },
  "kompass.agree": { lv: "Piekrītu", en: "Agree" },
  "kompass.neutral": { lv: "Neitrāli", en: "Neutral" },
  "kompass.disagree": { lv: "Nepiekrītu", en: "Disagree" },
  "kompass.skip": { lv: "Izlaist", en: "Skip" },
  "kompass.important": { lv: "Man tas ir svarīgi", en: "This matters to me" },
  "kompass.back": { lv: "Atpakaļ", en: "Back" },
  "kompass.results": { lv: "Rezultāti", en: "Results" },
  "kompass.see_results": { lv: "Skatīt rezultātus", en: "See results" },
  "kompass.match": { lv: "sakritība", en: "match" },
  "kompass.coverage": { lv: "programma atbild uz", en: "the programme addresses" },
  "kompass.of_answered": { lv: "no atbildētajiem jautājumiem", en: "of your answered statements" },
  "kompass.unranked": {
    lv: "Nav ierindots: programma atbild uz mazāk nekā pusi no taviem jautājumiem.",
    en: "Unranked: the programme addresses fewer than half of your answered statements.",
  },
  "kompass.min_answers": { lv: "Atbildi vismaz uz 5 apgalvojumiem, lai redzētu rezultātus.", en: "Answer at least 5 statements to see results." },
  "kompass.your_answer": { lv: "Tava atbilde", en: "Your answer" },
  "kompass.list_position": { lv: "Saraksta pozīcija", en: "List position" },
  "kompass.quote_note": { lv: "citāts no programmas", en: "programme quote, in Latvian" },
  "kompass.silent": { lv: "programma klusē", en: "programme is silent" },
  "kompass.details": { lv: "Salīdzinājums pa jautājumiem", en: "Statement-by-statement comparison" },
  "kompass.open_list": { lv: "Atvērt sarakstu", en: "Open list" },
