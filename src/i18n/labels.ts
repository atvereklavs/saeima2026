...
export const L = {
  ...
  "nav.debates": { lv: "Debates", en: "Debates" },
  "debates.heading": { lv: "Debates un diskusijas", en: "Debates and discussions" },
  "debates.intro": {
    lv: "Priekšvēlēšanu raidījumi un apskati, kuros saraksti tiek iztaujāti par savām programmām. Kopsavilkumi ir neitrāli citēto avotu atstāsti; pilnais saturs ir avotā.",
    en: "Pre-election broadcasts and reviews where the lists are questioned on their programmes. Summaries neutrally restate the cited coverage; the full content is at the source.",
  },
  "debates.list_section": { lv: "Debatēs un medijos", en: "In debates and media" },
  "debates.source": { lv: "Avots", en: "Source" },
  "debates.video": { lv: "Ieraksts", en: "Recording" },
  "debates.represented": { lv: "Pārstāvēja", en: "Represented by" },
  "debates.kind.debate": { lv: "debates", en: "debate" },
  "debates.kind.interview": { lv: "intervija", en: "interview" },
  "debates.kind.series": { lv: "raidījumu cikls", en: "series" },
  "debates.kind.article": { lv: "apskats", en: "review" },
  "debates.empty": { lv: "Vēl nav ierakstu.", en: "No entries yet." },
